...
{
    /// <summary>
    /// 方法按钮示例脚本，用于演示MethodButtonAttribute的使用
    /// </summary>
    public class MethodButtonExample : MonoBehaviour
    {
        /// <summary>
        /// 无参数方法示例
        /// </summary>
